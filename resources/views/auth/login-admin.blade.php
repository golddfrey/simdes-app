...
<head>
    ...
    <title>Login Admin • SIMDes</title>
...
<div class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <h1 class="text-2xl font-semibold text-gray-800">SIMDes — Login Admin</h1>
            <p class="text-sm text-gray-500 mt-1">Masuk menggunakan email</p>
        </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('kk.login') }}" class="text-sm text-indigo-600 hover:text-indigo-700">Login Kepala Keluarga</a>
                </div>
